/**
 * Footer.js - 사이트 하단 푸터 컴포넌트
 *
 * 구글 애드센스 승인을 위한 필수 요소:
 * - About, Contact, Privacy, Terms 링크
 * - 사업자 정보
 * - 저작권 정보
 * - 소셜 미디어 링크 (준비 중)
 */
      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottom}>
          <div className={styles.info}>
            ...
            <p className={styles.infoText}>
              <strong>문의</strong>: <a href="mailto:support@salearchive.com" className={styles.emailLink}>support@salearchive.com</a>
            </p>
            <p className={styles.infoText}>
          ...
          <div className={styles.disclaimer}>
            <p>
              본 서비스는 정보 제공 목적으로 운영되며, 실제 구매는 각 브랜드 공식 사이트에서 이루어집니다.
              상품 정보는 실시간으로 업데이트되지만, 최종 가격과 재고는 공식 사이트를 확인해주세요.
            </p>
          </div>
        </div>
      </div>
